...
gamification: {
    ...
    budgets: {
        ...
        overBudgetCapital: 'OVER',
        noBudgets: 'No budgets set. Create one to track your spending.',
        ...
        totalSpentCapital: 'TOTAL SPENT',
        budgetUsage: '{{percent}}% OF BUDGET USED',
        onTrack: 'On Track',
        onTrackDesc: 'Spending Balanced',
        overBudgetCount: 'Over',
        overBudgetDesc: 'Limit Exceeded',
        monthlyBudget: 'MONTHLY BUDGET',
        remainingCapital: 'LEFT',
        addSuccess: 'Budget created successfully',
        addError: 'Failed to create budget',
        deleteTitle: 'Delete Budget',
        deleteDescription: 'Are you sure you want to delete the "{{category}}" budget? This action cannot be undone.',
    ...
    goals: {
        ...
        goalsCompleted: '{{percent}}% OF GOALS COMPLETED',
        of: '/',
        completed: 'COMPLETED',
        daysLeft: 'days left',
        daysLeftCapital: 'DAYS LEFT',
        today: 'TODAY',
        overdue: 'OVERDUE',
        noGoals: 'No active goals. Set a new goal to start saving.',
        noGoalsTitle: 'No goals yet',
        noGoalsSubtitle: 'Set your first financial goal to reach your dreams.',
    ...
    analytics: {
        title: 'Analytics',
        subtitle: 'Analyze your financial performance and spending habits.',
        ...
        noData: 'No data',
        incomeExpenseAnalysis: 'INCOME AND EXPENSE ANALYSIS',
        categoryDistribution: 'CATEGORY DISTRIBUTION',
        monthlyComparison: 'MONTHLY COMPARISON',
        assetDistribution: 'ASSET DISTRIBUTION',
        netSavingsAnalysis: 'NET SAVINGS ANALYSIS',
        limitedHistory: 'LIMITED HISTORY (7 DAYS)',
        proHistory: 'PRO HISTORY (1 YEAR)',
        upgradeForFull: 'Upgrade to Pro+ for full history',
